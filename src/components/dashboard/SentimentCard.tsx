        ...
        <div className="space-y-3 p-3 rounded-xl bg-muted/20">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-success text-xs font-semibold px-2 py-0.5 rounded-full bg-success/10">Rising</span>
            </div>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">News Volume</span>
            <span className="font-mono-numbers font-medium">{sentimentData.newsVolume} articles</span>
          </div>
        </div>
        ...
        <div className="space-y-2.5 pt-3 border-t border-border/50">
          ...
          {sentimentData.topHeadlines.slice(0, 2).map((headline, index) => (
            <div key={index} className="group flex gap-2.5 text-xs p-2 rounded-lg hover:bg-muted/30 cursor-pointer transition-colors">
              ...
              <span className="text-muted-foreground line-clamp-2 group-hover:text-foreground transition-colors">{headline}</span>
